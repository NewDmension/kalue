...
export default function AuthPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      if (mode === 'signup') {
        ...
        // Si la confirmación de email está ON, puede no haber sesión todavía.
        ...
        setMsg('Cuenta creada. Si hay confirmación por email, revisa tu bandeja y luego entra.');
        setMode('signin');
      } else {
  ...
  return (
    <div className="min-h-[calc(100vh-0px)] flex items-center justify-center px-4 py-10 text-white">
      <div className="w-full max-w-[560px] card-glass rounded-2xl border border-white/10 p-6 sm:p-7">
