...
export async function POST(req: Request) {
  try {
    ...
    const nameRaw = getString(body, 'name');
    ...
    // seguridad: actualizar solo dentro de este workspace
    ...
    return json(200, { ok: true, integration: data as unknown as { id: string; provider: ProviderKey } });
  } catch (e: unknown) {
